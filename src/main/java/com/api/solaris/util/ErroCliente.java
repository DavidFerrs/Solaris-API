...
public class ErroCliente {
	...
	public static ResponseEntity<CustomErrorType> erroClienteNaoEnconrtrado(Long id) {
		return new ResponseEntity<>(new CustomErrorType(String.format(ErroCliente.CLIENTE_NAO_CASTRADO, id)),
				HttpStatus.NOT_FOUND);
	}
	
	public static ResponseEntity<CustomErrorType> erroSemClientesCadastrados() {		
		return new ResponseEntity<>(new CustomErrorType(ErroCliente.CLIENTES_NAO_CASTRADOS),
