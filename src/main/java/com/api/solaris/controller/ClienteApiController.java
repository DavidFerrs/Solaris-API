...
public class ClienteApiController {
	...
	public ResponseEntity<?> consultarCliente(@PathVariable("id") UUID id) {
	...
	public ResponseEntity<?> atualizarCliente(@PathVariable("id") UUID id, @RequestBody ClienteDTO clienteDTO) {
	...
	public ResponseEntity<?> removerCliente(@PathVariable("id") UUID id) {
